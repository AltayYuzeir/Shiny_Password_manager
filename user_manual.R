...
user_manual =  HTML(
  ...
  paste(
    ...
    tags$em(
      span("15. The Random Password is displayed in a special font to improve readability between symbols such 0 (digit zero) and O (upper case o), and I (upper case i) and l (lower case L).", style = style)
    ),
    sep = "<br/>"
  )
)
